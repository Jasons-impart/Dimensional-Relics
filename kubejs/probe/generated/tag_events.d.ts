...
declare namespace TagEvent {
    ...
    class Stuff extends Internal.TagEventJS {
    get(id: Special.StuffTag): Internal.TagWrapper
    add(tag: Special.StuffTag, ...id: Special.Stuff[]): Internal.TagWrapper
    remove(tag: Special.StuffTag, ...id: Special.Stuff[]): Internal.TagWrapper
    removeAll(tag: Special.StuffTag): Internal.TagWrapper
    removeAllTagsFrom(...id: Special.Stuff[]): Internal.TagWrapper
    }
}