...
declare namespace Internal {
    ...
    class GlowLichenGrowthBlock extends Internal.ZetaBushBlock implements Internal.BonemealableBlock {
        ...
        */
        ...
        setCondition(arg0: Internal.BooleanSupplier_): Internal.ZetaBushBlock;
        /**
         * @deprecated
        */
        builtInRegistryHolder(): Internal.Holder$Reference<Internal.Block>;
    ...
    */
    ...
    class InterfaceBlock extends Internal.TopLevelElement {
        constructor(position: number, variable: Internal.Variable_)
        getClass(): typeof any;
        getEndOffset(): number;
        toString(): string;
        notifyAll(): void;
        ...
        getStartOffset(): number;
        static convert(context: icyllis.arc3d.compiler.Context_, pos: number, modifiers: Internal.Modifiers_, blockType: icyllis.arc3d.compiler.tree.Type_, instanceName: string): Internal.InterfaceBlock;
        static make(context: icyllis.arc3d.compiler.Context_, pos: number, variable: Internal.Variable_): Internal.InterfaceBlock;
        hashCode(): number;
        wait(): void;
        getBlockName(): string;
        wait(arg0: number): void;
...
declare namespace icyllis.modernui.view {
    abstract class InputEvent {
        ...
        toString(): string;
        notifyAll(): void;
        abstract getEventTime(): number;
        abstract cancel(): void;
        abstract copy(): this;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        hashCode(): number;
        abstract getEventTimeNano(): number;
