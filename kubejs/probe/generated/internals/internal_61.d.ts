...
declare namespace Internal {
    ...
    class LevelChunk extends Internal.ChunkAccess implements Internal.ICapabilityProviderImpl<Internal.LevelChunk> {
        ...
        */
        ...
        getSectionsCount(): number;
        handler$cjc000$fabric_data_attachment_api_v1$transferProtoChunkAttachement(world: Internal.ServerLevel_, protoChunk: Internal.ProtoChunk_, entityLoader: Internal.LevelChunk$PostLoadProcessor_, ci: Internal.CallbackInfo_): void;
        wait(): void;
        getSectionIndexFromSectionY(arg0: number): number;
    ...
    class BeekeeperArmorItem extends Internal.ArmorItemCoFH {
        ...
        */
        ...
        setModId(arg0: string): Internal.ArmorItemCoFH;
        isDamaged(arg0: Internal.ItemStack_): boolean;
        canFitInsideContainerItems(): boolean;
        wait(): void;
        "setFoodProperties(java.util.function.Consumer)"(consumer: Internal.Consumer_<Internal.FoodBuilder>): void;
    ...
    class Beam extends Feature<Internal.NoneFeatureConfiguration> {
        constructor()
        getClass(): typeof any;
        ...
        get class(): typeof any
        static base: Internal.StructureTemplate;
        static middle: Internal.StructureTemplate;
        static top: Internal.StructureTemplate;
    }
    type Beam_ = Beam;
