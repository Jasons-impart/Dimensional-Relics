    ...
    */
    ...
    class ForlornBridgeStructure extends Internal.Structure {
        ...
        */
        ...
        static BRIDGE_SECTION_WIDTH: (4) & (number);
        static BRIDGE_SECTION_LENGTH: (6) & (number);
    }
    ...
    interface BehaviourSand extends Internal.AddMineableShovel, org.betterx.bclib.behaviours.interfaces.BlockBehaviour {
    }
    type BehaviourSand_ = BehaviourSand;
...
declare namespace mekanism.api.gear {
    class ModuleData <MODULE extends Internal.ICustomModule<MODULE>> implements Internal.IModuleDataProvider<MODULE> {
        ...
        get moduleData(): mekanism.api.gear.ModuleData<MODULE>
        get maxStackSize(): number
        get translationKey(): string
