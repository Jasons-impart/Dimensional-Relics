...
declare namespace Internal {
    ...
    class EnergyAcceptorCache extends Internal.AcceptorCache<Internal.IStrictEnergyHandler> {
        constructor(transmitter: Internal.Transmitter_<Internal.IStrictEnergyHandler, any, any>, transmitterTile: Internal.TileEntityTransmitter_)
        getCachedAcceptor(side: Internal.Direction_): Internal.LazyOptional<Internal.IStrictEnergyHandler>;
        getClass(): typeof any;
        getConnectedAcceptors(sides: Internal.Set_<Internal.Direction>): Internal.List<Internal.IStrictEnergyHandler>;
        toString(): string;
        hasStrictEnergyHandlerAndListen(tile: Internal.BlockEntity_, side: Internal.Direction_): boolean;
        notifyAll(): void;
        isAcceptorAndListen(tile: Internal.BlockEntity_, side: Internal.Direction_, capability: Internal.Capability_<Internal.IStrictEnergyHandler>): boolean;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        invalidateCachedAcceptor(side: Internal.Direction_): void;
        hashCode(): number;
        wait(): void;
        getConnectedAcceptor(side: Internal.Direction_): Internal.LazyOptional<Internal.IStrictEnergyHandler>;
        clear(): void;
        wait(arg0: number): void;
        getConnectedAcceptorTile(side: Internal.Direction_): Internal.BlockEntity;
        equals(arg0: any): boolean;
        get class(): typeof any
    }
    type EnergyAcceptorCache_ = EnergyAcceptorCache;
