...
declare namespace Internal {
    class BlockInversionPillar extends Internal.Block implements Internal.EntityBlock {
    ...
    type BlockInversionPillar_ = BlockInversionPillar;
    class CapabilityConfigurable$BlockEntityBuilder extends Internal.CapabilityBuilderForge<Internal.BlockEntity, mekanism.api.IConfigurable> {
        constructor()
        getClass(): typeof any;
        toString(): string;
        notifyAll(): void;
        onSneakRightClick(onSneakRightClick: Internal.BiFunction_<Internal.BlockEntity, Internal.Player, string>): this;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        hashCode(): number;
        wait(): void;
        side(direction: Internal.Direction_): Internal.CapabilityBuilder<Internal.BlockEntity, mekanism.api.IConfigurable, Internal.Capability<T>>;
        wait(arg0: number): void;
        onRightClick(onRightClick: Internal.BiFunction_<Internal.BlockEntity, Internal.Player, string>): this;
        availableOn(isAvailable: Internal.BiPredicate_<Internal.BlockEntity, Internal.Direction>): Internal.CapabilityBuilder<Internal.BlockEntity, mekanism.api.IConfigurable, Internal.Capability<T>>;
        equals(arg0: any): boolean;
        getCapability(instance: Internal.BlockEntity_): mekanism.api.IConfigurable;
        get class(): typeof any
    }
    type CapabilityConfigurable$BlockEntityBuilder_ = CapabilityConfigurable$BlockEntityBuilder;
    ...
    class StyleRE implements mcjty.lostcities.worldgen.lost.regassets.IAsset<Internal.StyleRE> {
        constructor(arg0: Internal.List_<Internal.List<Internal.PaletteSelector>>)
        getClass(): typeof any;
        hashCode(): number;
        ...
        notify(): void;
        wait(arg0: number, arg1: number): void;
        getRandomPaletteChoices(): Internal.List<Internal.List<Internal.PaletteSelector>>;
        get class(): typeof any
        set registryName(arg0: ResourceLocation_)
        get registryName(): ResourceLocation
        get randomPaletteChoices(): Internal.List<Internal.List<Internal.PaletteSelector>>
        static readonly CODEC: Internal.Codec<Internal.StyleRE>;
    }
    type StyleRE_ = StyleRE | Special.Styles;
    ...
    interface IReactorEnvironment {
        abstract getFuelToReactorHeatTransferCoefficient(): number;
        abstract getModerator(arg0: BlockPos_): Internal.IRadiationModerator;
        abstract getReactorHeat(): Internal.IHeat;
        abstract getNextIrradiationSource(): Internal.IIrradiationSource;
        abstract getPartsCount(arg0: Internal.IReactorPartType_): number;
        abstract isSimulator(): boolean;
        abstract getReactorToCoolantSystemHeatTransferCoefficient(): number;
        abstract getReactorHeatLossCoefficient(): number;
        abstract refuel(): void;
        abstract ejectWaste(arg0: boolean): void;
        abstract getReactorVolume(): number;
        get fuelToReactorHeatTransferCoefficient(): number
        get reactorHeat(): Internal.IHeat
        get nextIrradiationSource(): Internal.IIrradiationSource
        get simulator(): boolean
        get reactorToCoolantSystemHeatTransferCoefficient(): number
        get reactorHeatLossCoefficient(): number
        get reactorVolume(): number
    }
    type IReactorEnvironment_ = IReactorEnvironment;
    ...
    interface IInfuser extends Internal.IInstrument {
        ...
        lookupInfusionRecipe(arg0: Internal.Level_): Internal.IInfusionRecipe;
    ...
    class BlockPlacerTile extends Internal.IndustrialAreaWorkingTile<Internal.BlockPlacerTile> {
        ...
        */
        ...
        get paused(): boolean
        get self(): Internal.BlockPlacerTile
        get level(): Internal.Level
    ...
    */
    ...
    class Program$Type extends Internal.Enum<Internal.Program$Type> implements Internal.ProgramTypeAccessor {
        ...
        notifyAll(): void;
        getExtension(): string;
        static createProgramType$oculus_$md$6bcef1$0(arg0: string, arg1: number, arg2: string, arg3: string, arg4: number): Internal.Program$Type;
        name(): string;
        hashCode(): number;
        ordinal(): number;
        wait(): void;
