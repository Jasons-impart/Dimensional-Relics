...
declare namespace Internal {
    ...
    class ExtraBlockUniversalCable extends Internal.ExtraBlockSmallTransmitter implements Internal.IHasTileEntity<Internal.ExtraTileEntityUniversalCable>, Internal.ITypeBlock {
        constructor(arg0: Internal.CableTier_)
        /**
         * @deprecated
        */
        getSignal(arg0: Internal.BlockState_, arg1: Internal.BlockGetter_, arg2: BlockPos_, arg3: Internal.Direction_): number;
    ...
    interface IElementTypeProvider {
        ...
        (): sirttas.elementalcraft.api.element.ElementType_;
    }
    type IElementTypeProvider_ = IElementTypeProvider | (()=> sirttas.elementalcraft.api.element.ElementType_);
    ...
    interface IPlayerConfigStringableOptionClientStorageAPI <T extends Internal.Comparable<T>> extends Internal.IPlayerConfigOptionClientStorageAPI<T> {
        abstract getOption(): Internal.IPlayerConfigOptionSpecAPI<T>;
        abstract getComment(): string;
        abstract getType(): T;
        abstract getTranslation(): string;
        abstract getId(): string;
        abstract getCommandOutputWriterCast(): Internal.Function<any, net.minecraft.network.chat.Component>;
        ...
        abstract getStringValidator(): Internal.BiPredicate<Internal.IPlayerConfigClientStorageAPI<any>, string>;
        ...
        get id(): string
        get commandOutputWriterCast(): Internal.Function<any, net.minecraft.network.chat.Component>
        ...
        get stringValidator(): Internal.BiPredicate<Internal.IPlayerConfigClientStorageAPI<any>, string>
        get commentTranslationArgs(): any[]
        get commandInputParser(): Internal.Function<string, T>
        get translationArgs(): any[]
    }
    type IPlayerConfigStringableOptionClientStorageAPI_<T extends Internal.Comparable<T>> = IPlayerConfigStringableOptionClientStorageAPI<T>;
    ...
    class IFluidContainerManager$ContainerEditMode extends Internal.Enum<Internal.IFluidContainerManager$ContainerEditMode> implements Internal.IHasTextComponent, Internal.IIncrementalEnum<Internal.IFluidContainerManager$ContainerEditMode> {
        getClass(): typeof any;
        static valueOf(name: string): Internal.IFluidContainerManager$ContainerEditMode;
        getDeclaringClass(): typeof Internal.IFluidContainerManager$ContainerEditMode;
        getTextComponent(): net.minecraft.network.chat.Component;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        compareTo(arg0: any): number;
        byIndex(index: number): this;
        static values(): Internal.IFluidContainerManager$ContainerEditMode[];
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<Internal.IFluidContainerManager$ContainerEditMode>>;
        getNext(): this;
        getPrevious(): this;
        static valueOf<T extends Internal.Enum<T>>(arg0: T, arg1: string): T;
        toString(): string;
        getNext(arg0: Internal.Predicate_<Internal.IFluidContainerManager$ContainerEditMode>): this;
        adjust(arg0: number, arg1: Internal.Predicate_<Internal.IFluidContainerManager$ContainerEditMode>): this;
        notifyAll(): void;
        compareTo(arg0: Internal.IFluidContainerManager$ContainerEditMode_): number;
        name(): string;
        hashCode(): number;
        static byIndexStatic(index: number): Internal.IFluidContainerManager$ContainerEditMode;
        abstract ordinal(): number;
        wait(): void;
        getPrevious(arg0: Internal.Predicate_<Internal.IFluidContainerManager$ContainerEditMode>): this;
        wait(arg0: number): void;
        adjust(arg0: number): this;
        "compareTo(java.lang.Object)"(arg0: any): number;
        equals(arg0: any): boolean;
        "compareTo(mekanism.common.tile.interfaces.IFluidContainerManager$ContainerEditMode)"(arg0: Internal.IFluidContainerManager$ContainerEditMode_): number;
        get class(): typeof any
        get declaringClass(): typeof Internal.IFluidContainerManager$ContainerEditMode
        get textComponent(): net.minecraft.network.chat.Component
        get next(): Internal.IFluidContainerManager$ContainerEditMode
        get previous(): Internal.IFluidContainerManager$ContainerEditMode
        static readonly EMPTY: (Internal.IFluidContainerManager$ContainerEditMode) & (Internal.IFluidContainerManager$ContainerEditMode);
        static readonly BOTH: (Internal.IFluidContainerManager$ContainerEditMode) & (Internal.IFluidContainerManager$ContainerEditMode);
        static readonly FILL: (Internal.IFluidContainerManager$ContainerEditMode) & (Internal.IFluidContainerManager$ContainerEditMode);
    }
    type IFluidContainerManager$ContainerEditMode_ = IFluidContainerManager$ContainerEditMode | "both" | "empty" | "fill";
    ...
    class ScrollBlock extends Internal.TetraBlock implements Internal.ISchematicProviderBlock, Internal.EntityBlock, Internal.ICraftingEffectProviderBlock {
        constructor(arg0: Internal.ScrollBlock$Arrangement_)
        /**
         * @deprecated
        */
        getSignal(arg0: Internal.BlockState_, arg1: Internal.BlockGetter_, arg2: BlockPos_, arg3: Internal.Direction_): number;
        ...
        */
        ...
        get mod(): string
        set hasCollision(arg0: boolean)
        static readonly sound: (SoundType) & (SoundType);
    }
    type ScrollBlock_ = ScrollBlock;
    ...
    class RangeShrineUpgradeBlock extends Internal.AbstractDirectionalShrineUpgradeBlock {
        constructor()
        /**
         * @deprecated
        */
        ...
        */
        ...
        get mod(): string
        set hasCollision(arg0: boolean)
        static readonly NAME: ("shrine_upgrade_range") & (string);
    }
    type RangeShrineUpgradeBlock_ = RangeShrineUpgradeBlock;
    ...
    interface IIrradiationSource {
        abstract isLinked(): boolean;
        abstract getWorldPosition(): BlockPos;
        abstract getControlRodInsertionRatio(): number;
        abstract getIrradiationDirections(): Internal.Direction[];
        get linked(): boolean
        get worldPosition(): BlockPos
        get controlRodInsertionRatio(): number
        get irradiationDirections(): Internal.Direction[]
    }
    type IIrradiationSource_ = IIrradiationSource;
...
declare namespace org.betterx.betterend.blocks.basis {
    class PedestalBlock extends Internal.BaseBlockNotFull implements Internal.EntityBlock, Internal.TagProvider {
        ...
        */
        ...
        get mod(): string
        set hasCollision(arg0: boolean)
        static readonly HAS_ITEM: (Internal.BooleanProperty) & (Internal.BooleanProperty);
        static readonly STATE: Internal.EnumProperty<Internal.EndBlockProperties$PedestalState>;
        static readonly HAS_LIGHT: (Internal.BooleanProperty) & (Internal.BooleanProperty);
    }
