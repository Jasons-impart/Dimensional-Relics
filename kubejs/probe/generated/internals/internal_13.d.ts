...
declare namespace Internal {
    ...
    class InputConstants$Key implements Internal.AccessInputConstantsKey {
        ...
        wait(arg0: number, arg1: number): void;
        hashCode(): number;
        static getNAME_MAP$controlling_$md$9765b0$0(): Internal.Map<any, any>;
        wait(): void;
        getName(): string;
    ...
    class BlockModStem extends Internal.RotatedPillarBlock {
    ...
    type BlockModStem_ = BlockModStem;
    ...
    class FirePylonBlockEntity extends Internal.AbstractShrineBlockEntity {
        constructor(arg0: BlockPos_, arg1: Internal.BlockState_)
        requestModelDataUpdate(): void;
        "areCapsCompatible(net.minecraftforge.common.capabilities.CapabilityDispatcher)"(arg0: Internal.CapabilityDispatcher_): boolean;
        hasAttached(type: Internal.AttachmentType_<any>): boolean;
    ...
    type FirePylonBlockEntity_ = FirePylonBlockEntity;
