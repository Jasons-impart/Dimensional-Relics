...
declare namespace Internal {
    ...
    class ClientLevel$ClientLevelData implements Internal.SkyblockWorldInfo, Internal.WritableLevelData, Internal.MixinClientWorldProperties {
        ...
        handler$dfo000$polylib$setDifficulty(newDifficulty: Internal.Difficulty_, ci: Internal.CallbackInfo_): void;
    ...
    class MinMaxBounds$Doubles extends Internal.MinMaxBounds<number> implements Internal.DoublesAccess {
        ...
        toString(): string;
        static create$lychee_$md$051599$0(arg0: number, arg1: number): Internal.MinMaxBounds$Doubles;
        notifyAll(): void;
        isAny(): boolean;
    ...
    class PressurePlateBlock$Sensitivity extends Internal.Enum<Internal.PressurePlateBlock$Sensitivity> {
        static valueOf<T extends Internal.Enum<T>>(arg0: T, arg1: string): T;
        getClass(): typeof any;
        getDeclaringClass(): typeof Internal.PressurePlateBlock$Sensitivity;
        static valueOf(arg0: string): Internal.PressurePlateBlock$Sensitivity;
        toString(): string;
        "compareTo(net.minecraft.world.level.block.PressurePlateBlock$Sensitivity)"(arg0: Internal.PressurePlateBlock$Sensitivity_): number;
        static values(): Internal.PressurePlateBlock$Sensitivity[];
        notifyAll(): void;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        compareTo(arg0: any): number;
        ...
        ordinal(): number;
        wait(): void;
        compareTo(arg0: Internal.PressurePlateBlock$Sensitivity_): number;
        wait(arg0: number): void;
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<Internal.PressurePlateBlock$Sensitivity>>;
        "compareTo(java.lang.Object)"(arg0: any): number;
        equals(arg0: any): boolean;
        get class(): typeof any
        get declaringClass(): typeof Internal.PressurePlateBlock$Sensitivity
        static readonly MOBS: (Internal.PressurePlateBlock$Sensitivity) & (Internal.PressurePlateBlock$Sensitivity);
        static readonly EVERYTHING: (Internal.PressurePlateBlock$Sensitivity) & (Internal.PressurePlateBlock$Sensitivity);
    }
    type PressurePlateBlock$Sensitivity_ = PressurePlateBlock$Sensitivity | "mobs" | "everything";
