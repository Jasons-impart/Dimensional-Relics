...
declare namespace Internal {
    ...
    class TagWorkbenchBlock extends Internal.DisplayTableBlock {
        constructor()
        /**
         * @deprecated
        */
    ...
    type TagWorkbenchBlock_ = TagWorkbenchBlock;
    interface IBlastingItem {
        canBlastBlock(world: Internal.Level_, pos: BlockPos_, state: Internal.BlockState_): boolean;
        abstract getBlastedBlocks(world: Internal.Level_, player: Internal.Player_, stack: Internal.ItemStack_, pos: BlockPos_, state: Internal.BlockState_): Internal.Map<BlockPos, Internal.BlockState>;
        findPositions(world: Internal.Level_, targetPos: BlockPos_, player: Internal.Player_, radius: number): Internal.Map<BlockPos, Internal.BlockState>;
        (world: Internal.Level, player: Internal.Player, stack: Internal.ItemStack, pos: BlockPos, state: Internal.BlockState): Internal.Map_<BlockPos, Internal.BlockState>;
    }
    type IBlastingItem_ = ((world: Internal.Level, player: Internal.Player, stack: Internal.ItemStack, pos: BlockPos, state: Internal.BlockState)=> Internal.Map_<BlockPos, Internal.BlockState>) | IBlastingItem;
    class SeagrassFeature extends Feature<Internal.ProbabilityFeatureConfiguration> {
    ...
    class NotBlockPredicate extends Internal.Record implements Internal.IBlockPosPredicate {
        constructor(predicate: Internal.IBlockPosPredicate_)
        ...
        getType(): Internal.BlockPosPredicateType<Internal.NotBlockPredicate>;
        ...
        get class(): typeof any
        get type(): Internal.BlockPosPredicateType<Internal.NotBlockPredicate>
        static readonly NAME: ("not") & (string);
        static readonly CODEC: Internal.Codec<Internal.NotBlockPredicate>;
    }
    type NotBlockPredicate_ = NotBlockPredicate;
    ...
    class CustomStatBuilder extends dev.latvian.mods.kubejs.registry.BuilderBase<ResourceLocation> {
        ...
        */
        displayName(name: net.minecraft.network.chat.Component_): dev.latvian.mods.kubejs.registry.BuilderBase<ResourceLocation>;
        getTranslationKeyGroup(): string;
        transformObject(obj: ResourceLocation_): ResourceLocation;
        /**
         * Sets the translation key for this object, e.g. `block.minecraft.stone`.
        */
        translationKey(key: string): dev.latvian.mods.kubejs.registry.BuilderBase<ResourceLocation>;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        /**
         * Combined method of formattedDisplayName().displayName(name).
        */
        formattedDisplayName(name: net.minecraft.network.chat.Component_): dev.latvian.mods.kubejs.registry.BuilderBase<ResourceLocation>;
        generateDataJsons(generator: Internal.DataJsonGenerator_): void;
        getRegistryType(): Internal.RegistryInfo<any>;
        /**
         * Adds a tag to this object, e.g. `minecraft:stone`.
        */
        tag(tag: ResourceLocation_): dev.latvian.mods.kubejs.registry.BuilderBase<ResourceLocation>;
        toString(): string;
        notifyAll(): void;
        ...
        */
        formattedDisplayName(): dev.latvian.mods.kubejs.registry.BuilderBase<ResourceLocation>;
